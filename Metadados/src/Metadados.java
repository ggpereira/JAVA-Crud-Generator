...
public class Metadados 
{
	public Connection open()
	{
		...
		{
			System.out.println("N�o encontrou o driver chamado " + DB.JDBC_DRIVER + "na memória");
		}
	...
	public DatabaseMetaData getMetaData()
	{
		...
		{
			System.out.println("Não foi poss�vel ler os metadados: " + e.getMessage());
		}
	...
	public void printGeneralMetadata()	//Imprime informa��es sobre o BD utilizado
	{
		try
		{
		...
		{
			System.out.println("N�o foi poss�vel encontrar os metadados..." + e.getMessage());
		}
	}
	...
	public Collection<Tabela> tablesMetadata()
	{
		...
		getPrimaryKeyTables(tables);	/*Preecnhe as tabelas comas suas chaves prim�rias */
